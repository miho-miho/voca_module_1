  ...
  client.query(query, [targetWordIds], (err, result) => {
    ...
    instances.forEach((item) => {
      ...
      if (sameMidasi) {
        ...
        console.log(sameMidasi.inst["reibun"]);
      } else {
